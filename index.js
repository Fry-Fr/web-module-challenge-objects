...
const chalupa = createMenuItem('chalupa', 3.50, 'lunch');
const pizza = createMenuItem('pizza', 10, 'dinner');
const spaghetti = createMenuItem('spaghetti', 7, 'dinner');
console.log(chalupa);
console.log(pizza);
...
export const burger = {
  ...
  discount: function(str){
    if(str == 'teacher' || str == 'student'){
      return this.price - (this.price*.25).toExponential(1);
    }else if(str == 'public'){
      return this.price - (this.price*.1).toExponential(1);
    }
  }
}
...
reviews.push({name: "Ryan", rating: 5,feedback: "I love learning this nerdy computer science and coding" });
console.log(reviews)
...
function getLastReview(array) {
  ...
  return `${array[z].name} gave the restaurant a ${array[z].rating} star review, and their feedback was: ${array[z].feedback}`
} 
